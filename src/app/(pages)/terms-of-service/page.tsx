            ...
            <div className="text-foreground space-y-8">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  you do not agree to these Terms of Service, please do not use
                  our service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4 leading-relaxed">
                  You agree to use YourOnlineClock only for lawful purposes and
                  in a way that does not infringe the rights of, restrict or
                  inhibit anyone else&apos;s use of the service. Prohibited
                  behavior includes:
                </p>
                <ul className="text-muted-foreground ml-6 list-disc space-y-2">
                  <li>
                  ...
                  <li>
                    Using the service to send spam or other unsolicited messages
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  YourOnlineClock and its licensors. The service is protected by
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  is&apos; basis. YourOnlineClock makes no warranties, expressed
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  YourOnlineClock, even if YourOnlineClock or a YourOnlineClock
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  the laws of the jurisdiction in which YourOnlineClock
